...
new Vue({
    ...
    methods: {
        getKeeps: function getKeeps() {
            ...
            var urlKeeps = 'tasks';
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(urlKeeps).then(function (response) {
        ...
        updateKeep: function updateKeep(id) {
            ...
            var url = 'tasks/' + id;
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(url, this.fillKeep).then(function (response) {
                _this4.getKeeps();
                _this4.fillKeep = { 'id': '', 'keep': '' };
                _this4.errors = [];
                $("#edit").modal('hide');
